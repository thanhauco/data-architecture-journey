...
default_args = {
    'owner': 'data_eng_legal',
    'retries': 3,
    'retry_delay': timedelta(minutes=5)
}

with DAG('legal_pipeline_v1', 
         default_args=default_args, 
         schedule_interval='@daily', 
         start_date=datetime(2023, 1, 1),
         catchup=False,
         tags=['legal', 'production']) as dag:
