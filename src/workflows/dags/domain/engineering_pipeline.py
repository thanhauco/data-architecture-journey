...
default_args = {
    'owner': 'data_eng_engineering',
    'retries': 3,
    'retry_delay': timedelta(minutes=5)
}

with DAG('engineering_pipeline_v1', 
         default_args=default_args, 
         schedule_interval='@daily', 
         start_date=datetime(2023, 1, 1),
         catchup=False,
         tags=['engineering', 'production']) as dag:
