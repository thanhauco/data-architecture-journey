...
default_args = {
    'owner': 'data_eng_support',
    'retries': 3,
    'retry_delay': timedelta(minutes=5)
}

with DAG('support_pipeline_v1', 
         default_args=default_args, 
         schedule_interval='@daily', 
         start_date=datetime(2023, 1, 1),
         catchup=False,
         tags=['support', 'production']) as dag:
